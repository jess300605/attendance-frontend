...
import { exportAttendanceForPrinting, exportSimpleAttendanceByClassroom } from "../../services/exportService" // Importar la función de exportación
import type { Classroom, AttendanceSession, Attendance } from "../../types"
import "./SimpleAttendance.css"
import PrintExportButton from "../../components/PrintExportButton" // Importar el componente de botón
import SimpleAttendanceExportButton from "../../components/SimpleAttendanceExportButton"
import MonthYearPicker from "../../components/MonthYearPicker" // Importar el selector de mes y año
...
const SimpleAttendance: React.FC = () => {
  ...
  const handleExportForPrinting = () => {
    ...
    try {
      ...
      if (success) {
        toast.success("Asistencia exportada para impresión exitosamente")
        setShowPrintOptions(false)
      } else {
        toast.error("Error al exportar asistencia para impresión")
      }
    } catch (error) {
  ...
  const handleExportSimpleAttendance = () => {
    ...
    try {
      // Preparar los datos para la exportación simple
      ...
      <div className="simple-attendance">
        <div className="attendance-header">
          ...
          <div className="header-actions">
            ...
            {/* Botón para mostrar opciones de impresión */}
            <button
